  ...
  return (
    <div className={`h-screen flex justify-center items-center ${isDarkMode ? 'bg-gray-900' : 'bg-gray-100'}`}>
      <div className="w-96 p-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <h1 className="text-3xl font-semibold mb-4 text-center text-gray-800 dark:text-white">Data Query Page</h1>
        <div className="mb-4">
          <label htmlFor="chapterNumber" className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
            Chapter Number:
          </label>
          <input
            type="number"
        ...
        <div className="mb-4">
          <label htmlFor="index" className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
            Index:
          </label>
          <input
            type="number"
        ...
        {data && (
          <div className="mt-6 p-4 bg-gray-200 dark:bg-gray-700 rounded-lg">
            <h2 className="text-lg font-semibold mb-2 text-gray-700 dark:text-white">Fetched Data:</h2>
